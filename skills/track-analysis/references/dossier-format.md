...
windows       {label: {t0, t1, bar, sub_grid_suspect, grids}}  per-window drum grids;
              sub_grid_suspect=true marks a window auto-flagged for failure mode 2
```
